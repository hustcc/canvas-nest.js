  ...
  _createClass(CanvasNest, [{
    ...
    value: function bindEvent() {
      ...
      window.onmousemove = function (e) {
        _this2.current.x = e.clientX - _this2.el.offsetLeft + (document.scrollingElement || document.documentElement).scrollLeft; // 当存在横向滚动条时，x坐标再往右移动滚动条拉动的距离
        _this2.current.y = e.clientY - _this2.el.offsetTop + (document.scrollingElement || document.documentElement).scrollTop; // 当存在纵向滚动条时，y坐标再往下移动滚动条拉动的距离
